...
const CommentReplyComponent: FC<loggedUserType> = ({
  ...
  const style = {
    mainDiv: `w-[100%] h-[150px]  bg-[#232323] p-5 gap-4 flex items-end  rounded-[5px] boxshaddow`,
  ...
  return (
    <div className={style.mainDiv}>
      <div className="flex flex-col w-[10%] items-center  gap-4">
      ...
      <textarea
        ...
        className="px-10 h-[100px] bg-gray-800 outline-none  w-[80%]   py-4 rounded-[8px] "
